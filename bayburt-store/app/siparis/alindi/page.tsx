      ...
      <div className="container max-w-2xl">
        <Reveal className="flex justify-center">
          <span className="grid h-16 w-16 place-items-center rounded-full border border-gold-600/50 bg-gold-500/10">
            <Check className="h-7 w-7 text-gold-400" aria-hidden />
          </span>
        </Reveal>
        ...
        <Reveal
          ...
          from="above"
          delay={0.06}
          className="mt-8 text-center font-display text-[clamp(2rem,5.5vw,3.25rem)] font-semibold uppercase leading-[1.12] tracking-tight text-balance text-white"
        >
          Siparişiniz alındı
        </Reveal>

        <Reveal as="p" delay={0.12} className="mt-6 text-center font-sans text-base leading-relaxed text-smoke">
        ...
        <Reveal delay={0.18} className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/koleksiyon"
            className="inline-flex w-full items-center justify-center gap-3 border border-white/20 px-7 py-3.5 font-sans text-[11px] uppercase tracking-luxe text-white transition-colors duration-500 ease-luxe hover:border-gold-600 hover:text-gold-300 sm:w-auto"
          >
            Koleksiyona dön
          ...
          <Link
            href="/iletisim"
            className="inline-flex w-full items-center justify-center px-7 py-3.5 font-sans text-[11px] uppercase tracking-wider2 text-ash transition-colors duration-300 hover:text-white sm:w-auto"
          >
        ...
        <Reveal delay={0.24} className="mt-10 text-center">
          <p className="font-sans text-[12px] text-ash">
            ...
            <a
              ...
              className="text-gold-400 underline underline-offset-4 transition-colors duration-300 hover:text-gold-200"
            >
              {contact.email}
            </a>{' '}
            adresine yazın.
