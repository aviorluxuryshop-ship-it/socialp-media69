  ...
  return (
    <div className="fixed inset-0 -z-10 bg-fade-void">
      <div className="flex h-full items-center justify-center">
        <div className="relative flex h-[52vh] w-[30vh] max-w-[220px] flex-col items-center justify-center rounded-[2.5rem] bg-gradient-to-b from-gaza-400 via-gaza-500 to-gaza-700 shadow-2xl">
